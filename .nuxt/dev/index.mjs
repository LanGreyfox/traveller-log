...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///home/ben/git/traveller-log/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/ben/git/traveller-log/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/ben/git/traveller-log/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///home/ben/git/traveller-log/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/ben/git/traveller-log/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/ben/git/traveller-log/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/ben/git/traveller-log/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/ben/git/traveller-log/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/ben/git/traveller-log/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/ben/git/traveller-log/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/ben/git/traveller-log/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/ben/git/traveller-log/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/ben/git/traveller-log/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/ben/git/traveller-log/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/ben/git/traveller-log/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/ben/git/traveller-log/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/ben/git/traveller-log/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/ben/git/traveller-log/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/ben/git/traveller-log/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/ben/git/traveller-log/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/ben/git/traveller-log/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/ben/git/traveller-log/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/ben/git/traveller-log/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///home/ben/git/traveller-log/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/ben/git/traveller-log/node_modules/unhead/dist/server.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///home/ben/git/traveller-log/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/ben/git/traveller-log/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///home/ben/git/traveller-log/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/ben/git/traveller-log/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ben/git/traveller-log","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ben/git/traveller-log/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ben/git/traveller-log/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ben/git/traveller-log/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/ben/git/traveller-log/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/ben/git/traveller-log/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _212itlAO5Bl7qXbaRpEz6kxL_hku0is2ApSo6wnz4 = (function(nitro) {
...
const _9800fcZMZhlapureUGgxBsUgfqBmmQOIZ_SgRlSBbwU = (nitroApp) => {
...
const plugins = [
  _212itlAO5Bl7qXbaRpEz6kxL_hku0is2ApSo6wnz4,
_9800fcZMZhlapureUGgxBsUgfqBmmQOIZ_SgRlSBbwU
];
...
const _1NbZ0_ = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/ben/git/traveller-log/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/ben/git/traveller-log/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _pU_poB = eventHandler(async (event) => {
  ...
  return await import('file:///home/ben/git/traveller-log/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _bzaN6y = eventHandler(async (event) => {
...
const _lazy_wUT32U = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _1NbZ0_, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_wUT32U, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _pU_poB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _pU_poB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _bzaN6y, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _bzaN6y, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wUT32U, lazy: true, middleware: false, method: undefined }
];
